...
class DataReader(object):
    def __init__(self, args):
        ...
        if args.all:
            self.json_files_main = {
                'combined': f'{infolder}/limits/nonres/combined/bbbb_bbll_bbtautau_bbyy_bbVV_WWWW-fullcorr/limits.json',
                'combined5ll': f'{infolder}/limits/nonres/combined/bbbb_bbtautau_bbyy_bbVV_WWWW-fullcorr/limits.json',
                'combined5VV': f'{infolder}/limits/nonres/combined/bbbb_bbll_bbtautau_bbyy_WWWW-fullcorr/limits.json',
                'combined5WW': f'{infolder}/limits/nonres/combined/bbbb_bbll_bbtautau_bbyy_bbVV-fullcorr/limits.json',
