...
def plot_spin0(args):
    ...
    scenario_map = {
        ...
        f'{args.resonant_type}-combined-A-bbbb_bbll_bbtautau_bbyy-nocorr.dat': (r'Top 3 + $b\bar{b}ll$', 'black'),
        f'{args.resonant_type}-combined-A-bbbb_bbtautau_bbVV_bbyy-nocorr.dat': (r'Top 3 + $b\bar{b}VV$', 'black'),
...
def plot_nonres(args):
    ...
    scenario_map = {
        ...
        f'{args.resonant_type}-combined-A-bbbb_bbll_bbtautau_bbyy-nocorr.dat': (r'\mathrm{Top 3 + $b\bar{b}ll}$', 13),
        f'{args.resonant_type}-combined-A-bbbb_bbtautau_bbVV_bbyy-nocorr.dat': (r'\mathrm{Top 3 + $b\bar{b}VV}$', 14),
