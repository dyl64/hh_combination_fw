...
int MakeLimitPlots_resonant_paper_newStyle2() 
{
  SetAtlasStyle();
  ...
  if (strModel.EqualTo("spin-0")) {
	...
	strOutfile = PathOut+"limit_plots/limits_spin0_bbbb_bbtt_pointExtension300_comb_"+version+"_exp";
      }
    }
  }
  ...
  if (strModel.EqualTo("spin-0")) {
	...
	//inFileNames["comb_F_bbbb_bbtautau_bbyy"] = Path+"limits/data-files/spin0-combined-F-bbbb_bbtautau_bbyy-fullcorr.dat";
      ...
      inFileNames["comb_A_bbbb_bbtautau"] = Path+"limits/data-files/spin0-combined-A-bbbb_bbtautau-nocorr.dat";
  ...
  if (strModel.EqualTo("spin-0")) {
    ...
    //strYaxisTitle = "95% CL upper limit on #sigma(pp #rightarrow X #rightarrow HH) [pb]";
