...
def CalcLimit_quickstats(workspace_path, poi_name, data_name, output_limit_path, 
                         ...
                         verbose=False, minimizer_options=None, cache=False, save_summary=False):
    ...
    if os.path.exists(output_limit_path) and cache:
    ...
    try:
        ...
        asymptotic_cls.save(output_limit_path, summary=save_summary)
...
def CalcLimit_new(mass_point, workspace_path, output_limit_dir, data_name, poi_name=None,
                  ...
                  verbose=False, minimizer_options=None, parallel=-1, cache=False, save_summary=False):
