...
FILEPATH="./input/workspaces/vfinal_02/bbyy/lambda_140invfb"
...
for i in $(seq -20 20); do
    ...
    python ${FRAMEWORKPATH]/${SCRIPTPATH} ${FRAMEWORKPATH]/${FILEPATH}/${lambda}.root ${FRAMEWORKPATH]/${FILEPATH}/${lambda}_resorted.root mu_hh

    echo "Removing ${FRAMEWORKPATH]/${FILEPATH}/${lambda}.root"
    rm -rf ${FRAMEWORKPATH]/${FILEPATH}/${lambda}.root
