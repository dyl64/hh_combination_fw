...
def main():
    ...
    for key in commonPoints:
        ...
        avgLimits[key].append([math.sqrt(float(x)**2/4 + float(y)**2/4) for x,y in zip(limits1[1:3], limits2[1:3])])
        avgLimits[key].append([(float(limits1[3])+float(limits2[3]))/2])
        avgLimits[key].append([math.sqrt(float(x)**2/4 + float(y)**2/4) for x,y in zip(limits1[4:6], limits2[4:6])])
        avgLimits[key].append([(float(limits1[6])+float(limits2[6]))/2])
        avgLimits[key].append([math.sqrt(float(x)**2/4 + float(y)**2/4) for x,y in zip(limits1[7:9], limits2[7:9])])
        avgLimits[key].append([(float(limits1[9])+float(limits2[9]))/2])
        avgLimits[key].append([math.sqrt(float(x)**2/4 + float(y)**2/4) for x,y in zip(limits1[10:12], limits2[10:12])])
        avgLimits[key].append([(float(limits1[12])+float(limits2[12]))/2])
        avgLimits[key].append([math.sqrt(float(x)**2/4 + float(y)**2/4) for x,y in zip(limits1[13:15], limits2[13:15])])
        avgLimits[key].append([(float(limits1[15])+float(limits2[15]))/2])
        avgLimits[key].append([math.sqrt(float(x)**2/4 + float(y)**2/4) for x,y in zip(limits1[16:18], limits2[16:18])])
        avgLimits[key].append([(float(limits1[18])+float(limits2[18]))/2])
        avgLimits[key].append([math.sqrt(float(x)**2/4 + float(y)**2/4) for x,y in zip(limits1[19:21], limits2[19:21])])
        avgLimits[key].append([(float(limits1[21])+float(limits2[21]))/2])
        avgLimits[key].append([math.sqrt(float(x)**2/4 + float(y)**2/4) for x,y in zip(limits1[22:24], limits2[22:24])])
